...
apt-get update
apt-get install -y wget unzip libglib2.0-0 libnss3 libgconf-2-4 libfontconfig1 libx11-6 libxext6 libxrender1 libxi6 libxtst6 libxkbcommon0 libdbus-1-3 libgtk-3-0 libasound2 libgbm1 libxshmfence1 libgl1-mesa-glx
